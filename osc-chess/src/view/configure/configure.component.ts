...
import { BehaviorSubject, Observable, Subject, Subscription, first, map, tap } from 'rxjs';
...
export class ConfigureComponent implements OnDestroy {
  ...
  public saveChanges(): void {
    ...
    this.webSocketService.updateConfiguration(this.form.getRawValue());
  }
