...
export class WebSocketService {
  public s: BehaviorSubject<Array<Configuration>> = new BehaviorSubject<Array<Configuration>>([]);
  private ws: Websocket;

  constructor() {
    this.ws = new WebsocketBuilder("ws://localhost:42421")
      .onOpen((i, ev) => console.log("opened"))
      .onClose((i, ev) => console.log("closed"))
      .onError((i, ev) => console.log("error"))
      .onMessage((i, ev) => {
        this.s.next(JSON.parse(ev.data));
      })
  ...
  public updateConfiguration(configurations: Array<Configuration>) {
    this.ws.send(JSON.stringify(configurations));
  }
}
