Shader "Unlit/NewUnlitShader"
{
    Properties {
        ...
        _FirstBitsBothCaptured ("FirstBitsBothCaptured", Range(0,255)) = 0
        ...
        _IndexBitsBothCaptured ("IndexBitsBothCaptured", Range(0,15)) = 0
        ...
        _LastBitsBothCaptured ("LastBitsBothCaptured", Range(0,255)) = 0
