Shader "Unlit/NewUnlitShader"
{
    Properties {
        ...
        _FirstBitsPromotion ("FirstBitsPromotion", Range(0,255)) = 0
        ...
        _IndexBitsPromotion ("IndexBitsPromotion", Range(0,15)) = 0
        ...
        _LastBitsPromotion ("LastBitsPromotion", Range(0,255)) = 0
